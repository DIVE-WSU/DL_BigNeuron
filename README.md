...
Please cite Caffe in your publications if it helps your research:
    ...
    @article{jia2014caffe,
      ...
      Year = {2014}
## Caffe_3D_Segmentation
This version of caffe is modifided from master version of caffe, particularlly for BigNeuron Project (https://http://alleninstitute.org/bigneuron/about/)
Functionalities:
- 1. Fully Convolutional  networks  with 3D data.
